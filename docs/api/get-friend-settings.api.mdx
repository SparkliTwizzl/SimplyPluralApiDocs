...
api:
  {
    ...
    "postman":
      {
        "name": "Get friend settings",
        "description":
          { "content": "Get a friend from a user (Typically your user)", "type": "text/plain" },
        "url":
          {
            "path": ["v1", "friend", ":userId", ":friendId"],
            "host": ["{{baseUrl}}"],
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) String Id of the origin friend (Typically you)",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
                ...
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) String Id of the destination friend (Typically your friend)",
                      "type": "text/plain",
                    },
                  "type": "any",
                  "value": "",
