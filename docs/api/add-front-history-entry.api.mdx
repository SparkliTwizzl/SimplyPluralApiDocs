...
description: "Add a Front history entry, optionally by an Id"
...
api:
  {
                ...
                "schema":
                  {
                    ...
                    "properties":
                      {
                        "customStatus":
                          { "description": "Custom status of the front entry", "type": "string" },
                        "custom":
                          {
    ...
    "jsonRequestBodyExample":
      { "customStatus": "string", "custom": true, "live": true, "startTime": 0, "endTime": 0 },
    "info":
      {
    ...
    "postman":
      {
        "name": "Add front history entry",
        "description":
          { "content": "Add a Front history entry, optionally by an Id", "type": "text/plain" },
        "url":
          {
            "path": ["v1", "frontHistory", ":docId"],
            "host": ["{{baseUrl}}"],
              ...
              [
                {
                  "disabled": false,
                  "description":
                    { "content": "(Required) String Id of the document", "type": "text/plain" },
                  "type": "any",
                  "value": "",
                  "key": "docId",
                },
...
Add a Front history entry, optionally by an Id
    ...
    <details style={{}} className={"openapi-markdown__details"} data-collapsed={false} open={true}>
      ...
      <ul style={{ marginLeft: "1rem" }}>
        <SchemaItem
          ...
          schema={{ description: "Custom status of the front entry", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"custom"}
          required={false}
