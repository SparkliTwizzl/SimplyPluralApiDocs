...
id: add-note
title: "Add note"
description: "Add a note, optionally by an Id"
...
api:
  {
                ...
                "schema":
                  {
                    ...
                    "properties":
                      {
                        "note": { "description": "Note text", "type": "string" },
                        "title": { "description": "Name of the note", "type": "string" },
                        "color":
                          {
    ...
    "jsonRequestBodyExample":
      { "note": "string", "title": "string", "color": "string", "member": true, "date": 0 },
    "info":
      {
    ...
    "postman":
      {
        "name": "Add note",
        "description": { "content": "Add a note, optionally by an Id", "type": "text/plain" },
        "url":
          {
            "path": ["v1", "note", ":docId"],
            "host": ["{{baseUrl}}"],
              ...
              [
                {
                  "disabled": false,
                  "description":
                    { "content": "(Required) String Id of the note", "type": "text/plain" },
                  "type": "any",
                  "value": "",
                  "key": "docId",
                },
...
Add a note, optionally by an Id
    ...
    <details style={{}} className={"openapi-markdown__details"} data-collapsed={false} open={true}>
      ...
      <ul style={{ marginLeft: "1rem" }}>
        <SchemaItem
          ...
          schema={{ description: "Note text", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"title"}
          required={false}
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "Name of the note", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"color"}
          required={false}
