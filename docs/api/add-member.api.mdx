...
id: add-member
title: "Add member"
description: "Add a member, optionally by an Id"
...
api:
  {
                    ...
                    "properties":
                      {
                        ...
                        "desc": { "description": "Description of the member", "type": "string" },
                        "color":
                          {
                            "description": "Color of the object (\\#ffffff, \\#ffffffff or ffffff)",
                            "type": "string",
                          },
                        "pronouns": { "description": "Pronouns of the member", "type": "string" },
                        "pkId":
                          {
                            "description": "PluralKit ID of the member, 5-letter string",
                            "type": "string",
                          },
                        "avatarUrl": { "description": "URL for the avatar", "type": "string" },
                        "private":
                          { "description": "Whether this object is private", "type": "boolean" },
                        "preventTrusted":
                          {
    ...
    "postman":
      {
        "name": "Add member",
        "description": { "content": "Add a member, optionally by an Id", "type": "text/plain" },
        "url":
          {
            "path": ["v1", "member", ":docId"],
            "host": ["{{baseUrl}}"],
...
Add a member, optionally by an Id
    ...
    <details style={{}} className={"openapi-markdown__details"} data-collapsed={false} open={true}>
      ...
      <ul style={{ marginLeft: "1rem" }}>
        <SchemaItem
          ...
          schema={{ description: "Name of the member", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"desc"}
          required={false}
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "Description of the member", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"color"}
          required={false}
        ...
        <SchemaItem
          ...
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "Pronouns of the member", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"pkId"}
          required={false}
        ...
        <SchemaItem
          ...
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "URL for the avatar", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"private"}
          required={false}
          schemaName={"boolean"}
          qualifierMessage={undefined}
          schema={{ description: "Whether this object is private", type: "boolean" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"preventTrusted"}
          required={false}
        ...
        <SchemaItem collapsible={true} className={"schemaItem"}>
          <details style={{}} className={"openapi-markdown__details"}>
            ...
            <div style={{ marginLeft: "1rem" }}>
              <div style={{ marginTop: ".5rem", marginBottom: ".5rem" }}>Info object</div>
              <SchemaItem
                collapsible={false}
                name={"*"}
                required={false}
                ...
                schema={{
                  type: "string",
                  description:
                    "Info object entry, id/key has to match an id/key from the user object, value is the value string",
                }}></SchemaItem>
            </div>
          </details>
        </SchemaItem>
