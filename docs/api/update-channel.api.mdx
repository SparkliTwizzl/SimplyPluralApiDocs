...
api:
  {
                ...
                "schema":
                  {
                    ...
                    "properties":
                      {
                        "name": { "description": "Channel name", "type": "string" },
                        "desc": { "description": "Description of the channel", "type": "string" },
                      },
                    "title": "chatChannel",
                  },
              },
    ...
    "jsonRequestBodyExample": { "name": "string", "desc": "string" },
    "info":
      {
    ...
    <details style={{}} className={"openapi-markdown__details"} data-collapsed={false} open={true}>
      ...
      <ul style={{ marginLeft: "1rem" }}>
        <SchemaItem
          ...
          schema={{ description: "Channel name", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"desc"}
          required={false}
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "Description of the channel", type: "string" }}></SchemaItem>
      </ul>
    </details>
  </TabItem>
</MimeTabs>
