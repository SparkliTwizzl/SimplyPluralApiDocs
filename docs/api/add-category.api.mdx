...
api:
  {
                    ...
                    "properties":
                      {
                        ...
                        "desc": { "description": "Description of the category", "type": "string" },
                        "channels":
                          {
                            "items": { "type": "string" },
    ...
    "jsonRequestBodyExample": { "name": "string", "desc": "string", "channels": ["string"] },
    "info":
      {
    ...
    <details style={{}} className={"openapi-markdown__details"} data-collapsed={false} open={true}>
      ...
      <ul style={{ marginLeft: "1rem" }}>
        <SchemaItem
          ...
          schema={{ description: "Category name", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"desc"}
          required={false}
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "Description of the category", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"channels"}
          required={false}
