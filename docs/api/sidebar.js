module.exports = [
  { type: "doc", id: "api/simply-plural-api" },
  {
    type: "category",
    label: "Analytics",
    link: { type: "doc", id: "api/analytics" },
    items: [
      { type: "doc", id: "api/get-analytics", label: "Get analytics", className: "api-method get" },
    ],
  },
  {
    type: "category",
    label: "Automated Timers",
    link: { type: "doc", id: "api/automated-timers" },
    items: [
      {
        type: "doc",
  ...
  },
  {
    ...
    link: { type: "doc", id: "api/board-messages" },
    items: [
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Chat Messages",
    link: { type: "doc", id: "api/chat" },
    items: [
      { type: "doc", id: "api/get-message", label: "Get message", className: "api-method get" },
      { type: "doc", id: "api/add-message", label: "Add message", className: "api-method post" },
      {
        type: "doc",
      ...
      { type: "doc", id: "api/get-messages", label: "Get messages", className: "api-method get" },
    ],
  },
  {
    type: "category",
    label: "Chat Categories",
    link: { type: "doc", id: "api/chat-categories" },
    items: [
      { type: "doc", id: "api/get-category", label: "Get category", className: "api-method get" },
      { type: "doc", id: "api/add-category", label: "Add category", className: "api-method post" },
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Chat Channels",
    link: { type: "doc", id: "api/chat-channels" },
    items: [
      { type: "doc", id: "api/get-channel", label: "Get channel", className: "api-method get" },
      { type: "doc", id: "api/add-channel", label: "Add channel", className: "api-method post" },
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Comments",
    link: { type: "doc", id: "api/comments" },
    items: [
      { type: "doc", id: "api/get-comments", label: "Get comments", className: "api-method get" },
      { type: "doc", id: "api/add-comment", label: "Add comment", className: "api-method post" },
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Custom Fronts",
    link: { type: "doc", id: "api/custom-fronts" },
    items: [
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Friends",
    link: { type: "doc", id: "api/friends" },
    items: [
      { type: "doc", id: "api/get-friends", label: "Get friends", className: "api-method get" },
      {
        type: "doc",
      ...
      { type: "doc", id: "api/add-friend", label: "Add friend", className: "api-method post" },
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Front History",
    link: { type: "doc", id: "api/front-history" },
    items: [
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Groups",
    link: { type: "doc", id: "api/groups" },
    items: [
      { type: "doc", id: "api/get-group", label: "Get group", className: "api-method get" },
      { type: "doc", id: "api/add-group", label: "Add group", className: "api-method post" },
      { type: "doc", id: "api/update-group", label: "Update group", className: "api-method patch" },
      {
        type: "doc",
        id: "api/delete-group",
        label: "Delete group",
  ...
  },
  {
    type: "category",
    label: "Members",
    link: { type: "doc", id: "api/members" },
    items: [
      { type: "doc", id: "api/get-member", label: "Get Member", className: "api-method get" },
      { type: "doc", id: "api/add-member", label: "Add member", className: "api-method post" },
      {
        type: "doc",
  ...
  },
  {
    type: "category",
    label: "Notes",
    link: { type: "doc", id: "api/notes" },
    items: [
      { type: "doc", id: "api/get-note", label: "Get note", className: "api-method get" },
      { type: "doc", id: "api/add-note", label: "Add note", className: "api-method post" },
      { type: "doc", id: "api/update-note", label: "Update note", className: "api-method patch" },
      { type: "doc", id: "api/delete-note", label: "Delete note", className: "api-method delete" },
      { type: "doc", id: "api/get-all-notes", label: "Get all notes", className: "api-method get" },
    ],
  },
  {
    type: "category",
    label: "Polls",
    link: { type: "doc", id: "api/polls" },
    items: [
      { type: "doc", id: "api/get-poll", label: "Get poll", className: "api-method get" },
      { type: "doc", id: "api/add-poll", label: "Add poll", className: "api-method post" },
      { type: "doc", id: "api/update-poll", label: "Update poll", className: "api-method patch" },
      { type: "doc", id: "api/delete-poll", label: "Delete poll", className: "api-method delete" },
      { type: "doc", id: "api/get-all-polls", label: "Get all polls", className: "api-method get" },
    ],
  },
  {
    type: "category",
    label: "PluralKit",
    link: { type: "doc", id: "api/plural-kit" },
    items: [
      {
        type: "doc",
  ...
  },
  {
    ...
    link: { type: "doc", id: "api/repeated-timers" },
    items: [
      {
        type: "doc",
    ...
    items: [
      {
        ...
        label: "Get your authed String Id",
        className: "api-method get",
      },
      { type: "doc", id: "api/get-user", label: "Get user", className: "api-method get" },
      { type: "doc", id: "api/update-user", label: "Update user", className: "api-method patch" },
      { type: "doc", id: "api/set-username", label: "Set username", className: "api-method patch" },
      {
        type: "doc",
