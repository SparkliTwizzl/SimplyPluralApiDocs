...
id: add-poll
title: "Add poll"
description: "Add a Poll, optionally by an Id"
...
api:
  {
                ...
                "schema":
                  {
                    ...
                    "properties":
                      {
                        "name": { "description": "Name of the poll", "type": "string" },
                        "desc": { "description": "Description of the poll", "type": "string" },
                        "allowAbstain":
                          {
                                ...
                                "properties":
                                  {
                                    ...
                                    "comment":
                                      { "description": "Comment on the vote", "type": "string" },
                                    "vote":
                                      {
    ...
    "postman":
      {
        "name": "Add poll",
        "description": { "content": "Add a Poll, optionally by an Id", "type": "text/plain" },
        "url":
          {
            "path": ["v1", "poll", ":docId"],
            "host": ["{{baseUrl}}"],
              ...
              [
                {
                  "disabled": false,
                  "description":
                    { "content": "(Required) String Id of the Poll", "type": "text/plain" },
                  "type": "any",
                  "value": "",
                  "key": "docId",
                },
...
Add a Poll, optionally by an Id
    ...
    <details style={{}} className={"openapi-markdown__details"} data-collapsed={false} open={true}>
      ...
      <ul style={{ marginLeft: "1rem" }}>
        <SchemaItem
          ...
          schema={{ description: "Name of the poll", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"desc"}
          required={false}
          schemaName={"string"}
          qualifierMessage={undefined}
          schema={{ description: "Description of the poll", type: "string" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          name={"allowAbstain"}
          required={false}
        ...
        <SchemaItem
          ...
          schemaName={""}
          qualifierMessage={undefined}
          schema={{ description: "Milliseconds since epoch for this timestamp/date" }}></SchemaItem>
        <SchemaItem
          collapsible={false}
          ...
          schemaName={""}
          qualifierMessage={undefined}
          schema={{ description: "Whether the description supports markdown" }}></SchemaItem>
        ...
        <SchemaItem collapsible={true} className={"schemaItem"}>
          <details style={{}} className={"openapi-markdown__details"}>
            ...
            <div style={{ marginLeft: "1rem" }}>
              <div style={{ marginTop: ".5rem", marginBottom: ".5rem" }}>Votes on the poll</div>
              <li>
                <div
                  style={{
                    fontSize: "var(--ifm-code-font-size)",
              ...
              <SchemaItem
                ...
                schemaName={"string"}
                qualifierMessage={undefined}
                schema={{ description: "ID of the member who votes", type: "string" }}></SchemaItem>
              <SchemaItem
                collapsible={false}
                name={"comment"}
                required={false}
                schemaName={"string"}
                qualifierMessage={undefined}
                schema={{ description: "Comment on the vote", type: "string" }}></SchemaItem>
              <SchemaItem
                collapsible={false}
                name={"vote"}
                required={false}
